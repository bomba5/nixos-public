# Module: modules/development/segger.nix
# Purpose: Install Segger J-Link host tools plus permissive udev rules to allow user access.
# Options: No custom options.
# Usage: Import on hosts doing embedded work with J-Link hardware.
{ pkgs, ... }:
